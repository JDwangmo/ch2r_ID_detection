...
{
    public class ShootScore:ParameterBase
    {
        public ShootScore(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["拍照效果"] != null)
                    {
                        String[] score = ((String)userSession.liveTable.Parameter["拍照效果"]).Split(',');
