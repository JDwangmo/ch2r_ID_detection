...
{ 
    ...
    {
        public Bluetooth (Areas.Chat.Models.UserSession userSession, string sentence) : base(userSession, sentence)
        {
            name = "蓝牙传输";
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["蓝牙传输"] != null)
                    {
                        list[i].normalData = (String)userSession.liveTable.Parameter["蓝牙传输"];
