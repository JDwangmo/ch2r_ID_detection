...
{
    public class ScreenScore:ParameterBase
    {
        public ScreenScore(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["屏幕效果"] != null)
                    {
                        String[] score = ((String)userSession.liveTable.Parameter["屏幕效果"]).Split(',');
