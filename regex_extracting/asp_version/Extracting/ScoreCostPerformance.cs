...
{
    public class ScoreCostPerformance : ParameterBase
    {
        public ScoreCostPerformance(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    scores.Add(Code.Inquiry.CalculateScore(pset[j], "性价比得分"));
                }
                ...
                {
                    if (userSession.liveTable.Parameter["性价比得分"] != null)
                    {
                        String[] score = ((String)userSession.liveTable.Parameter["性价比得分"]).Split(',');
