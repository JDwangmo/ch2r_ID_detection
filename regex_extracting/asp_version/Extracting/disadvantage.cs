...
{
    public class Disadvantage: ParameterBase
    {
        public Disadvantage(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["缺点"] != null)
                    {
                        list[i].normalData = (String)userSession.liveTable.Parameter["缺点"];
