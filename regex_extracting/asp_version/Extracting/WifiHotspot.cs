...
{ 
    public class WifiHotspot : ParameterBase
    {
        public WifiHotspot (Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["WIFI热点"] != null)
                    {
                        list[i].normalData = (String)userSession.liveTable.Parameter["WIFI热点"];
