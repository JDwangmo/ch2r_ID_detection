...
{
    public class BasicFunction : ParameterBase
    {
        public BasicFunction(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["基本功能"] != null)
                    {
                        list[i].normalData = (String)userSession.liveTable.Parameter["基本功能"];
