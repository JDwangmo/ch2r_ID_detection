...
{
    public class CostScore:ParameterBase
    {
        public CostScore(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["性价比"] != null)
                    {
                        String[] score = ((String)userSession.liveTable.Parameter["性价比"]).Split(',');
