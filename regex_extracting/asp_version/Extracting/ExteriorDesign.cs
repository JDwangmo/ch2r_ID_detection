...
{
    public class ExteriorDesign : ParameterBase
    {
        public ExteriorDesign(Areas.Chat.Models.UserSession userSession, string sentence)
        ...
        public override void Format()
        {
            for (int i = 0; i < list.Count; ++i)
            {
                ...
                {
                    if (userSession.liveTable.Parameter["外观设计"] != null)
                    {
                        list[i].normalData = (String)userSession.liveTable.Parameter["外观设计"];
